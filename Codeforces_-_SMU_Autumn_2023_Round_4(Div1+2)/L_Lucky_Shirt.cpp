 ...
 * ==================================================================================
 * Author:  north_h
 * Time:    2023-09-16 12:10:46
 *
 * Problem: L. Lucky Shirt
 * Contest: Codeforces - SMU Autumn 2023 Round 4(Div.1+2)
 * URL:     https://codeforces.com/group/L9GOcnr1dm/contest/473585/problem/L
 * MemoryL: 512 MB
 * TimeL:   2000 ms
 * ==================================================================================
 */
...
int32_t main() {
    ...
    // }
    string sans = "";
    string ss = "aAbBcCdDeEfFgGhHiIjJkKlLmMnNoOpPqQrRsStTuUvVwWxXyYzZ1234567890";
    string sss = "";
    for(int i = 1; i <= ans; i++) {
        for(int j = 0; j < 62; j++) {
            string s = "";
            for(int k = 1; k <= ans; k++)s += ss[j];
            cout << s << endl;
            // int x;
            // scanf("ACCESS DENIED (%d ms)", &x);
            // if(x>5+i*9){
